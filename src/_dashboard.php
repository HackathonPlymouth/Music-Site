...
if(isset($_SESSION['user_id'])) {
	...
	list($name, $balance) = mysql_fetch_array(mysql_query("SELECT name, balance FROM artist WHERE artist_id='$user_id'"), MYSQL_NUM);?>
	<h1>Welcome, <? echo $name;?></h1>
	<p><strong>Balance: &dollar;<? echo number_format($balance,2);?></strong></p>
